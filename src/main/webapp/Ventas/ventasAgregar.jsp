	...
	<div class="container card mb-1">
		...
		<div class="card-body">
			...
			<div class="row">
				...
				<input class="text-center col-1" type="number" id="codigo_venta" min="1" max="99999999999999999999">
			</div>
			<br>
		</div>
	</div>
	...
	<form autocomplete="off" method="get" action="./Ventas">
		<div class="container card">
			...
			<div>
				...
				<input type="hidden" name="codigo_venta" id="codigoVenta" required>
			</div>
			...
			<div>
				...
				<div class="row">
					...
					<div class="col"></div>
					<div class="col"></div>
					<button class="btn btn-dark btn-sm col-1" type="submit" name="opcion" value="confirmar">Confirmar</button>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		var sell = {
				...
				total: <%=venta.getTotal_venta()%>,
				valor: <%=venta.getValor_venta()%>,
				iva: <%=venta.getIva_venta()%>
				}
		listaVentas.push(sell);
		<%}%>	
	});
